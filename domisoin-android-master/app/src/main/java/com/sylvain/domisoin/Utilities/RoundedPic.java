...
/**
 * Created by Sylvain on 14/10/2016.
 */

public class RoundedPic {

    private Resources _mResources;

    public RoundedPic(Resources mResources) {
        _mResources = mResources;
    }
    ...
    public RoundedBitmapDrawable createRoundedBitmapDrawableWithBorder(Bitmap bitmap){
        ...
        */
        ...
        RoundedBitmapDrawable roundedBitmapDrawable = RoundedBitmapDrawableFactory.create(_mResources,roundedBitmap);
