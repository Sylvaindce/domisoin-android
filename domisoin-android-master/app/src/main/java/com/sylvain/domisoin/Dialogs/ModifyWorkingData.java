...
public class ModifyWorkingData extends DialogFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private RadioButton wd0 = null;
    private RadioButton wd1 = null;
    private RadioButton wd2 = null;
    private RadioButton wd3 = null;
    private RadioButton wd4 = null;
    private RadioButton wd5 = null;
    private RadioButton wd6 = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //WORKING DAY BEGN MALIK


        //WORKING DAY BEGIN
        wd0 = (RadioButton)view.findViewById(R.id.wd_0);
        wd0.setChecked(true);
        wd0.setPressed(true);

        wd1 = (RadioButton)view.findViewById(R.id.wd_1);
        wd1.setChecked(true);

        wd2 = (RadioButton)view.findViewById(R.id.wd_2);
        wd2.setChecked(true);


        wd3 = (RadioButton)view.findViewById(R.id.wd_3);
        wd3.setChecked(true);
  ;


        wd4 = (RadioButton)view.findViewById(R.id.wd_4);
        wd4.setChecked(true);


        wd5 = (RadioButton)view.findViewById(R.id.wd_5);
        wd5.setChecked(true);


        wd6 = (RadioButton)view.findViewById(R.id.wd_6);
        wd6.setChecked(true);
