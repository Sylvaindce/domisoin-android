...
public class NameSigninProFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Spinner spinner_spec = (Spinner)view.findViewById(R.id.spec_pro);
        ArrayAdapter<CharSequence> adapter_spec = ArrayAdapter.createFromResource(getContext(), R.array.planets_array, android.R.layout.simple_spinner_item);
